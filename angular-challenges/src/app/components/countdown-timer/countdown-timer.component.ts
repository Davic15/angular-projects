...
export class CountdownTimerComponent {
  ...
  get days(): string {
    ...
    const days = Math.floor(
      this.getTimeDifference() / (milliseconds * minutesInHours * minuteInSeconds * hoursInDay)
    )
  ...
  get hours(): string {
    ...
    const hours = Math.floor(
      (this.getTimeDifference() % (hoursInDay * minutesInHours * minuteInSeconds * milliseconds)) / (minutesInHours * minuteInSeconds * milliseconds)
    )
