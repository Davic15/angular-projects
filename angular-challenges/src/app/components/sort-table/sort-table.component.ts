...
export class SortTableComponent {
  @Input() public tableData: any[] = [
    { first: 'David 1', dob: '10/25/88', age: 32, living: true },
    { first: 'David 2', dob: '10/25/90', age: 31, living: true },
    { first: 'David 3', dob: '10/25/95', age: 20, living: false },
    { first: 'David 4', dob: '10/25/87', age: 35, living: true },
  ];
  ...
  private sortString(key: any): void {
    this.tableData.sort((value1: string, value2: string) => {
      ...
      const value2UpperCased = value2[key].toLocaleUpperCase();
      if (this.sortDirection) {
